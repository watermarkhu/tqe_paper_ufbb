...
\begin{tikzpicture}[x=1cm,y=1cm]
    ...
    \begin{scope}[scale=0.8, shift={(-7,0)}]
        ...
        \node[parameters] (inf) at (4.5,3) {size: 11, parity: 3\\root node $R_\nset: \dot{B}$};
...
\begin{tikzpicture}[on grid, scale=0.8]
    ...
    \begin{scope}[shift={(9.5,-2.5)}]
        ...
        \draw (0, -1) node[even, nodem, preaction={fill, white}]{} +(.3,0) node[align=left, anchor=west]{\footnotesize $\pi_N$ even };
    ...
    \foreach \x in {0,3,6}{\draw (\x,0) node [even, nodem, l1] (a\x) {\tiny$\nicefrac{1}{2}$} ++(0,-.7) node (ad\x) {0};}
    ...
    \begin{scope}[shift={(0,-2)}]
        ...
        \foreach \x in {0,3,6}{\DLINE{\x}{0}{2}{0}}
        \foreach \x in {0,3,6}{\draw (\x,0) node [even, l1] (e\x) {\small2} ++(0,-.7) node {0};}
    ...
    \begin{scope}[shift={(0,-4)}]
        \DLINE{0}{0}{8}{0}
        \draw (0,0) node [even, l1] (b0) {\small2} ++(0,-.7) node {0};
    ...
    \begin{scope}[shift={(12.5,0)}]
        ...
        \foreach \x in {0,3,6}{\DLINE{\x}{0}{2}{0}}
        \foreach \x in {0,3,6}{\draw (\x,0) node [even, nodem, l1] (c\x) {\tiny$\nicefrac{1}{2}$} ++(0,-.7) node {0};}
        ...
        \begin{scope}[shift={(0,-2)}]
            ...
            \node[smallarrow] at (6, -1.3) {};
            \foreach \x in {0,3,6}{\DLINE{\x}{0}{2}{0}}
            \foreach \x in {0,3,6}{\draw (\x,0) node [even, l1] (c\x) {\small2} ++(0,-.7) node {0};}
        ...
        \begin{scope}[shift={(0,-4)}]
            \DLINE{0}{0}{8}{0}
            \draw (0,0) node [even, l1] (d0) {\small2} ++(0,-.7) node {0};
