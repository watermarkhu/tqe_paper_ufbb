...
\begin{tikzpicture}[x=1cm,y=1cm]
    ...
    \begin{scope}[scale=0.8, shift={(-7,0)}]
        ...
        \node[parameters] (inf) at (4.5,3) {size: 11, parity: 3\\root node $\mathbf{R}_\nset: \dot{B}$};
    ...
    \begin{scope}[scale=0.8, shift={(9,0)}]
        ...
        \node[parameters, anchor=west, align=left] (ni) at (2,-.75){neighboring nodes,\\ boundary vertices,\\$\rho_N$, $\pi_N$, $\tilde{\delta}_N$, $\gamma_N$}; 
