...
[From here not optimized for paper]
...
\begin{definition}\label{def:fragmentation}
  ...
  \begin{equation}\label{eq:pfo}
    zfpe(\pre{k}\nset^e_{-1}) = \m{F}^e_k=\{\pre{k}\nset^{o}_1,...,\pre{k}\nset^o_{k_f}\} \hspace{1em} | \hspace{1em} zkfragnumber = 2i, i \in \mathbb{N}^*,
  \end{equation}
