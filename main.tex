...
% \usepackage{tikz}
% \usetikzlibrary{shapes,calc,math,patterns,arrows,positioning,fadings}
% % Required to make tikz work with ieeeaccess template
% % https://tex.stackexchange.com/questions/440422/tikz-package-causing-error-in-ieee-access-template
