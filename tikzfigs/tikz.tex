...
\tikzstyle{nodem}=[circle, draw=black, minimum size=10pt, l1, inner sep= 0pt]
...
\begin{tikzpicture}[x=1cm,y=1cm]
    ...
    \node at (-2.75, -0.7) {\emph{(a)} Cluster-tree (Union-Find)};
    \node at (3.1, -0.7) {\emph{(b)} Vertex-tree $\vset$};
    \node at (9.2,-.7) {\emph{(c)} Node-tree $\mathcal{N}$ (Node-Suspension)};
    ...
    \begin{scope}[shift={(-3,0)}]
        ...
        \node[draw, l1, align=left, opacity=0.5, text opacity=1] (inf) at (1,2) {size: 9\\parity: 9\\root node: $n_3$};
    ...
    \begin{scope}[shift={(7,0)}, y=0.9cm]
        % \node at (0.3, 3) {$\nset_r$};
        \node[even1] (a) at (1, 3) {3};
        \node[odd1]  (b) at (1, 2) {4};
        \node[odd1]  (c) at (1, 1) {5};
        ...
        \draw[l2, ->, dashed, color=mblue] (0, 1.3) -- +(45:0.85) arc (-45:0:.5) -- +(90:.6);
        \draw[l2, ->, dashed, color=mblue] (0, 0.3) -- +(45:0.85) arc (-45:0:.5) -- +(90:.2);
        \draw[l2, ->, dashed, color=mblue] (0.75,0.2) -- +(90:.3);
        \draw[l2, ->, dashed, color=mblue] (1.5,0.2) -- +(135:.4);
        \draw[l2, ->, dashed, color=mblue] (1.75,1.2) -- +(90:0.5) arc (0:45:.5) -- +(135:0.4);
        \draw[l2, ->, color=morange] (1.4, 3) -- +(-45:1.1) arc (45:0:0.5) -- +(-90:0.7);
        \draw[l2, ->, color=morange] (1.3, 2.1) -- +(-90:0.9) arc (180:225:.5) -- +(-45:0.7);
        \draw[l2, ->, color=morange] (0.6, 0.3) -- +(225:.3);
        \draw[l2, ->, color=morange] (1.3, 0.3) -- +(-90:.2);
        % \node[text=mblue] at (0,2.2) {Parity};
        % \node[text=morange] at (2.6,2.8) {Delay};
        
        
        \begin{scope}[shift={(3,0)}]
            \path (0,1.5) node[even1, minimum size=10]{} -- +(.5,0) node[anchor=west] {$n_p$ even};
            \path (0,1) node[odd1 , minimum size=10]{} -- +(.5,0) node[anchor=west] {$n_p$ odd};
            \draw[l2, ->, color=mblue, dashed] (-.25, .5) -- ++(0.5,0);
            \draw[l2, ->, color=morange] (-.25, 0) -- ++(0.5,0);
            \node[color=mblue, anchor=west] at (.5,.5) {Parity};
            \node[color=morange, anchor=west] at (.5,0) {Delay};
        \end{scope}
    \end{scope}
...
\begin{tikzpicture}[scale=0.75]
    ...
    \begin{scope}[shift={(4.5,0)}]
        ...
        \draw[l2, ->, dashed, color=mblue] (e4) ++(-.7,0) -- + (0,1);
        \draw[l2, ->, color=morange] (o3) ++(.7,-.5) -- +(0,-1.5);
    \end{scope}
    ...
    \begin{scope}[shift={(9.5,-2)}]
        ...
        \draw[l1] (o2) -- (o1) -- (o3) -- (e5) -- (e4);
        \draw[l2, <-, dashed, color=mblue] (e4) ++(-1.5,0) -- +(0,-3);
        \draw[l2, ->, color=morange] (e4) ++(.75,0) -- +(0,-3);
    \end{scope}
    ...
    \begin{scope}[shift={(1,1)}]
        \path (0, 2) node[known, minimum size=10] {} -- +(.5,0) node[anchor=west, align=left]{Suspension known};
        \path (0, 1.3) node[undef, minimum size=10] {} -- +(.5,0) node[anchor=west, align=left]{Suspension undefined};
        \draw[l2, ->, color=mblue, dashed] (7.25,2) -- ++(0.5,0);
        \node[color=mblue, anchor=west] at (8,2) {Parity};
        \draw[l2, ->, color=morange] (7.25, 1.3) -- ++(0.5,0);
        \node[color=morange, anchor=west] at (8,1.3) {Delay};
...
\begin{tikzpicture}[on grid, scale=0.8]
    ...
    \begin{scope}[shift={(9.5,-3.5)}]
        ...
        \draw (0, 0.5) node[odd, nodem]{} +(.2,0) node[align=left, anchor=west]{\footnotesize $n_p$ odd };
        \draw (0, -0.25) node[even, nodem]{} +(.2,0) node[align=left, anchor=west]{\footnotesize $n_p$ even };
    \end{scope}
