...
\begin{tikzpicture}[on grid, scale=0.8]
    ...
    \begin{scope}[shift={(9.5,-4)}]
        \node[node2, pattern=dots, pattern color=black!20!white] (n1) at (0,2) {\small$nr_1$}; 
        \node[node2, pattern=dots, pattern color=black!20!white] (n2) at (1.5,2) {\small$nr_2$}; 
    ...
    \node at (-.5,1) {\emph{(a)}};
    \node[smallarrow, label={[label distance=-3.7mm]0:\tiny 1}] at (4, -1.3) {};
    ...
    \begin{scope}[shift={(0,-2)}]
        \node[smallarrow, label={[label distance=-3.7mm]0:\tiny 2}] at (4, -1.3) {};
        \foreach \x in {0,3,6}{\DLINE{\x}{0}{2}{0}}
