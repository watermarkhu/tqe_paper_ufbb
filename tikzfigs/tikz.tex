...
\begin{tikzpicture}[x=1cm,y=1cm]
    ...
    \node at (-2.75, -0.7) {Cluster-tree (Union-Find)};
    \node at (3.1, -0.7) {Vertex-tree $\vset$};
    \node at (9.2,-.7) {Node-tree $\mathcal{N}$ (Node-Suspension)};
    ...
    \begin{scope}[shift={(-3,0)}]
        ...
        \node[draw, l1, align=left, opacity=0.5, text opacity=1] (inf) at (1,2) {size: 9\\parity: 9\\node root: $n_r$};
    ...
    \begin{scope}[shift={(7,0)}, y=0.9cm]
        ...
        \draw[l2, ->, color=mred] (1.4, 3) -- +(-45:1.1) arc (45:0:0.5) -- +(-90:0.7);
        \draw[l2, ->, color=mred] (1.3, 2.1) -- +(-90:0.9) arc (180:225:.5) -- +(-45:0.7);
        \draw[l2, ->, color=mred] (0.6, 0.3) -- +(225:.3);
        \draw[l2, ->, color=mred] (1.3, 0.3) -- +(-90:.2);
        ...
        \begin{scope}[shift={(3,0)}]
            ...
            \draw[l2, ->, color=mred] (-.25, 0) -- ++(0.5,0);
            \node[color=mblue, anchor=west] at (.5,.5) {Parity};
            \node[color=mred, anchor=west] at (.5,0) {Delay};
        \end{scope}
    \end{scope}
...
\begin{tikzpicture}[scale=0.75]
    ...
    \begin{scope}[shift={(4.5,0)}]
        ...
        \draw[l2, ->, color=mred] (o3) ++(.7,-.5) -- +(0,-1.5);
    \end{scope}
    ...
    \begin{scope}[shift={(9.5,-2)}]
        ...
        \draw[l2, ->, color=mred] (e4) ++(.75,0) -- +(0,-3);
    \end{scope}
    ...
    \begin{scope}[shift={(1,1)}]
        ...
        \draw[l2, ->, color=mred] (7.25, 1.3) -- ++(0.5,0);
        \node[color=mred, anchor=west] at (8,1.3) {Delay};
