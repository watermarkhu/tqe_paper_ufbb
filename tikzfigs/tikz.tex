...
\begin{tikzpicture}[scale=0.7]
    ...
    \begin{scope}[shift={(0, -4)}]
        ...
        \node[node, pattern=horizontal lines, pattern color=mblue] at (0,0) (d) {3};
        \node[nodel, pattern=dots , pattern color=mred] at (2,0) (e) {1};
        \node[node, pattern=vertical lines, pattern color=mgreen] at (4,0) (f) {3};
        \node at (0,-1) {$n_0$};
        \node at (2,-1) {$n_1$};
        \node at (4,-1) {$n_2$};
        \draw[l1] (d) -- (e) -- (f);
...
\begin{tikzpicture}[scale=0.75]
    ...
    \begin{scope}[shift={(-1, -3)}, scale=1.5]
        \node[tnode, pattern=horizontal lines, pattern color=mblue] at (0,0) (n0) {2};
        ...
        \node[tnode, pattern=vertical lines , pattern color=mred] at (2,0) (n1) {2};
        ...
        \node[tnode, pattern=horizontal lines, pattern color=mgreen] at (4,0) (n2) {2};
        \node at (0,-.7) {$sn_0$};
        \node at (1,-.7) {$jn_{1}$};
        \node at (2,-.7) {$sn_2$};
        \node at (3,-.7) {$jn_{3}$};
...
\begin{tikzpicture}[scale=0.95]
    \node (o1) [even, node1] at (1.5, 1) {$sn_1$};
    \node (o2) [even, node1] at (1, 0) {$sn_2$};
    \node (o3) [even, node1] at (2, 0) {$sn_o$};
    \node (e4) [undef] at (3.5,1) {$sn_3$};
    \node (e5) [undef] at (3.5,0) {$sn_e$};
    ...
    \node (o2) [even, node1] at (1, 0) {$sn_2$};
    \node (o3) [even, node1] at (2, 0) {$sn_o$};
    \node (e4) [undef] at (2,-2) {$sn_3$};
    \node (e5) [undef] at (2,-1) {$sn_e$};
    ...
    \node (o1) [undef] at (0.75, 0.75) {$sn_1$};
    \node (o2) [undef] at (0, 0) {$sn_2$};
    \node (o3) [undef] at (0, 1.5) {$se_o$};
    \node (e4) [undef] at (0,3) {$sn_3$};
    \node (e5) [undef] at (0.75,2.25) {$sn_e$};
    \draw[l1] (o2) -- (o1) -- (o3) -- (e5) -- (e4);
