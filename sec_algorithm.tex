...
If the sub-tree $\nset_Q$ is of even parity, i.e. $\overbar{\nset_Q}$, it must consist of a combination of some number of even branches and an even number odd branches. %, where the parity of the branch refers to the parity of the number of syndrome-nodes. 
