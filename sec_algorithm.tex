...
Similarly, the difference in node delay can be deduced for any combination of node types of $N,M$ and parity of $\nset_N$ (see \Cref{fig:nmcombi}):
\begin{align*}
